...
### bin/
Firmware binary files (executable code):
...
### resources/
Resource files (UI, fonts, hardware definitions):
...
### image/
SD card images and extracted components:
- `sdcard.work.img.xz` - Compressed working SD card image (Git ignored, too large)
...
- [ANALYSIS_WORKFLOW.md](../ANALYSIS_WORKFLOW.md) - Analysis workflow and MCP architecture
