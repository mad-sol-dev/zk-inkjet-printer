...
├── APP.bin                  # Main application firmware (2.5MB)
├── BOOT.bin                 # Bootloader
├── UI-QVGA.bin              # Start/Stop screen graphics
├── RES-HW.zkml              # Handwriting resource container
├── GUI-RES.zkml             # Font resource (Leelawadee UI)
├── sdcard.img               # SD card dump (1:1 raw)
├── memory_map.md            # Memory layout documentation
├── update_protocol.md       # Firmware update mechanism
